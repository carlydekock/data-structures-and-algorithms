...
const toLastNames = people => {
  // Solution code here...
  const newNames = people.map(value => `${value.firstName} ${value.lastName}`);
  return newNames;
};
...
const validateEmail = (email) => {
  // Solution code here...
  //source: RegExLib.com
  // const regex = /^\w+.\w+@[a-zA-Z]+?\.[a-zA-Z]{2,3}$/;
  const regex = /^\w+.\w+@[a-zA-Z]+?\.[netcomorg]{2,3}$/;
...
const validatePhoneNumber = (phoneNumber) => {
  // Solution code here...
  //source: RegExLib.com + help from Nicco (TA)
